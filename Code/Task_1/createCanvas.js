function createCanvas(body){
  ...
  tasks_list = [];
  tasks_list[0] = "Change the angle of vector B to make it equal to vector A."
  tasks_list[1] = "Change the magnitude of vector B to make it equal to vector A."
  tasks_list[2] = "Create a new vector."
  tasks_list[3] = "Delete the given vector."
  tasks_list[4] = "Create a new vector and make it equal to vector A."
  ...
  title = parent_svg.append("text").styles({"font-size": 2*screen_size}).attrs({x: 0.5*body_width, y: 4*screen_size}).text("Equality of Vectors");
  ...
  function help_slideshow(){
    ...
    var steps = [
      { imageUrl: '../../Images/vector_create.gif', imageWidth: '100%',
        html: '<span class="help_heading">Creating a vector</span> <br> <span class="help_body">Tap with two fingers to create a vector.</span>',
      },
      { imageUrl: '../../Images/vector_active.gif', imageWidth: '100%',
        html: '<span class="help_heading">Making vector active</span> <br> <span class="help_body">Click the centre of vector to make it active/inactive.</span>',
      },
      { imageUrl: '../../Images/vector_manipulate.gif', imageWidth: '100%',
        html: '<span class="help_heading">Manipulating a vector</span> <br> <span class="help_body">The magnitude and direction of an active vector(vector with colored background) can be changed</span>',
