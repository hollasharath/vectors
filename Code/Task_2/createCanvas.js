function createCanvas(body){
  ...
  tasks_list = [];
  tasks_list[0] = "Add the given vectors.";
  tasks_list[1] = "Explore the triangle law of vector addition.";
  tasks_list[2] = "Create two vectors, add them and create the resultant.";
  tasks_list[3] = "Explore commutative law: A+B = B+A";
  tasks_list[4] = "Explore associative law: (A+B)+C = A+(B+C)";
  tasks_list[5] = "Add two vectors to create the resultant with magnitude 12 and angle 60\u00B0";
  ...
  title = parent_svg.append("text").styles({"font-size": 2*screen_size}).attrs({x: 0.5*body_width, y: 4*screen_size}).text("Addition of Vectors - Triangle law");
  ...
  function help_slideshow(){
    ...
    var steps = [
      { imageUrl: '../../Images/vector_add_1.gif', imageWidth: '100%',
        html: '<span class="help_heading">Adding vectors</span> <br> <span class="help_body">Put the head of first vector on the tail of the second vector.</span>',
      },
      { imageUrl: '../../Images/vector_add_2.gif', imageWidth: '100%',
        html: '<span class="help_heading">Adding vectors</span> <br> <span class="help_body">Tap and hold the tail of the first vector and tap the head of the second vector. <br> The added vectors can be manipulated.</span>',
