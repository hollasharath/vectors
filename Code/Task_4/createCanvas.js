function createCanvas(body){
  ...
  tasks_list = [];
  tasks_list[0] = "Create a vector and resolve it.";
  tasks_list[1] = "Create a vector, resolve it and recombine it.";
  ...
  title = parent_svg.append("text").styles({"font-size": 2*screen_size}).attrs({x: 0.5*body_width, y: 4*screen_size}).text("Resolution of Vectors");
  ...
  function help_slideshow(){
    ...
    var steps = [
      { imageUrl: '../../Images/vector_resolve.gif', imageWidth: '100%',
        html: '<span class="help_heading">Resolving vectors</span> <br> <span class="help_body">Place your fingers on either side of the vector in active mode (two triangles would appear). Now swipe away from the vector.</span>',
      },
      { imageUrl: '../../Images/vector_recombine.gif', imageWidth: '100%',
        html: '<span class="help_heading">Recombining components</span> <br> <span class="help_body">Tap and hold the centre and tap the head of the vector.</span>',
